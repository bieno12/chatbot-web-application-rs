use actix_web::put;
use actix_web::{web,  get, Responder, HttpResponse, post, delete};
...
#[put("{conv_id}")]
async fn update_conversation(path: web::Path<(i32,)>, json: web::Json<ConversationInfo>) -> actix_web::Result<impl Responder>
{
